...
function SidebarProvider({
  ...
  // 사이드바의 내부 상태
  // 컴포넌트 외부에서 제어하기 위해 openProp과 setOpenProp 사용
  ...
  // data-state="expanded" 또는 "collapsed" 사용을 위한 상태 추가
  // Tailwind 클래스로 사이드바 스타일링 용이성 향상
