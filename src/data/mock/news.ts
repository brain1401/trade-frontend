import type { TradeNews, HSCodeNews, NewsCategory } from "../../types";
...
export const mockTradeNews: TradeNews[] = [
  ...
  },
  {
    ...
    category: "무역",
    tags: ["8507.10", "인도", "태평양", "경제", "프레임워크", "IPEF"],
    importance: "high" as const,
  },
  {
...
export const mockHSCodeNews: HSCodeNews[] = [
  {
    ...
    source: "관세청 공고",
    content: "스마트폰 HS Code 최신 규제 변경 안내 상세 내용...",
    category: "규제",
  ...
  },
  {
    ...
    source: "농림축산검역본부",
    content: "오렌지(HS Code: 0805.10) 수입 검역 강화 상세 내용...",
    category: "규제",
  ...
  },
  {
    ...
    source: "식품안전정보원",
    content: "포도주(HS Code: 2204.21) 라벨링 규정 변경 상세 내용...",
    category: "규제",
...
// 뉴스 데이터 유틸리티 함수들
export const getNewsById = (uuid: string, type: "trade" | "hscode") => {
  const newsArray = type === "trade" ? mockTradeNews : mockHSCodeNews;
  return newsArray.find((news) => news.uuid === uuid);
};
